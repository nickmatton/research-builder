...
- `paper/<slug>.pdf` — original.
- `paper/paper.txt` — extracted text with `--- Page N ---` markers. Generated by `scripts/extract-paper-text.py`. Use Read for known pages, Grep for keywords (e.g. "learning rate", "warmup").
